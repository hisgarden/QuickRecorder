...
final class RecordEngineTests: XCTestCase {
    ...
    override func tearDown() {
        // Clean up test keys
        let testKeys = ["saveDirectory", "videoFormat", "encoder", "videoQuality", "frameRate", "recordMic", "audioFormat", "audioQuality"]
        for key in testKeys {
    ...
    func testInitVideo_WithMicrophone_AddsMicInput() throws {
        ...
        throw XCTSkip("Skipping test - audio format validation requires real hardware and fails in test environments")
    }
    ...
    func testPrepareAudioRecording_MP3Format_CreatesM4AFile() {
        // Given
